...
export default class TaskModal extends Component {
  ...
  changeTaskModalTitle = (event) => {
    this.setState({ title: event.target.value });
  };
  changeTaskModalTask = (event) => {
    this.setState({ description: event.target.value });
  };
  changeTaskModalDate = (event) => {
            ...
            <>
              ...
              <Modal.Body>
                <input
                  ...
                  onChange={this.changeTaskModalTitle}
                ></input>
              </Modal.Body>
              ...
              <Modal.Body>
                <input
                  ...
                  onChange={this.changeTaskModalTask}
                ></input>
              </Modal.Body>
              <Modal.Body>
                <input
                  value={this.state.date}
                  onChange={this.changeTaskModalDate}
                ></input>
              </Modal.Body>
              <Modal.Footer>
